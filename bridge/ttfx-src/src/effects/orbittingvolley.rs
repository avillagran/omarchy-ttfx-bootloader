...
use crate::effects::common::{
    parse_easing, parse_gradient_direction, parse_gradient_steps, parse_non_negative_int,
    parse_non_negative_ratio, parse_positive_float, parse_symbol,
};
...
impl Effect for OrbittingVolley {
    fn build(&mut self, ctx: &mut EngineCtx) -> Result<(), EngineError> {
        ...
        .map_err(EngineError::Other)?;
        let final_gradient_coordinate_map = ctx
